...
public partial class OnboardingWindow : Window
{
    ...
    public event Action<string, string, string, string>? ApiKeysRegistered;
    ...
    private void OnApiUpsellRegister(object sender, RoutedEventArgs e)
    {
        ...
        if (modal.ShowDialog() == true)
            ApiKeysRegistered?.Invoke(modal.DeepLApiKey, modal.GeminiApiKey, modal.LangblyApiKey, modal.MyMemoryEmail);
    }
